...
class AdvocacyViewModel: ObservableObject {
    ...
    func electedOfficials(for state: String, university: University?) -> [ElectedOfficial] {
        ...
        let baseOfficials = AdvocacyData.officials(forState: selectedState, university: university)
        return baseOfficials.map { official in
            ElectedOfficial(
                name: official.name,
                office: official.office,
                chamber: official.chamber,
                party: official.party,
                state: selectedState.isEmpty ? official.state : selectedState,
